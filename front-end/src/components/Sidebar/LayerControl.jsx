...
import { Layers, Droplets, CloudRain, TriangleAlert, LifeBuoy, Waves } from 'lucide-react';
...
const LayerControl = () => {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-md shadow-xl rounded-2xl p-5 border border-white/50 w-full" data-test-id="layer-control">
