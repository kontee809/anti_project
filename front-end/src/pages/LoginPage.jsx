...
const LoginPage = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center p-6 bg-slate-950 relative overflow-hidden" data-test-id="login-page">
      ...
      <div className="w-full max-w-md ui-card p-8 relative z-10 fade-slide-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-2">Truy cập hệ thống giám sát lũ AnTi Flood</p>
        </div>
